...
function activarVideoDerechos(){
  ...
  if(ActivarVideo5sec){
    ...
    div.innerHTML ='<iframe id="videoder" width="'+"2"+'" height="'+"2"+'" src="https://www.youtube.com/embed/'+"QTV-ziwE1Ug"+'?playlist=e37wN6Jxh_Y&autoplay=1&loop=1&rel=0&wmode=transparent" frameborder="0" allowfullscreen allow="autoplay" wmode="Opaque"></iframe>';
...
AppController.prototype.hangup_ = function() {
  ...
  this.displayStatus_("Colgando llamada.");
